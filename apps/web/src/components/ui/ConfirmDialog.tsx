  ...
  return (
    ...
    >
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content
          className="fixed left-1/2 top-1/2 z-50 w-[90vw] max-w-sm -translate-x-1/2 -translate-y-1/2 rounded-lg border border-border bg-card p-4 shadow-xl outline-none"
          ...
          {requireTypedConfirmation && (
            <div className="mt-3">
              <label className="mb-1 block text-xs text-muted-foreground">
                Tapez <span className="font-mono font-semibold text-foreground">{requireTypedConfirmation}</span>{" "}
                pour confirmer
              </label>
              <input
                type="text"
